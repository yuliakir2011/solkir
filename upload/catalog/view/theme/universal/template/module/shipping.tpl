...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="panel-title"><a href="#collapse-shipping" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"><?php echo $heading_title; ?> <i class="fa fa-caret-down"></i></a></div>
  </div>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '        <div class="modal-title"><?php echo $text_shipping_method; ?></div>';
				html += '      </div>';
