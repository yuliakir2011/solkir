<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
	...
	<div class="form-group">
      <label class="col-sm-2 control-label" for="input-payment-company_id"><?php echo $entry_company_id; ?></label>
      <div class="col-sm-10">
        <input type="text" name="company_id" value="" placeholder="<?php echo $entry_company_id; ?>" id="input-payment-company_id" class="form-control" />
      </div>
    </div>
	<div class="form-group">
      <label class="col-sm-2 control-label" for="input-payment-tax_id"><?php echo $entry_tax_id; ?></label>
      <div class="col-sm-10">
        <input type="text" name="tax_id" value="" placeholder="<?php echo $entry_tax_id; ?>" id="input-payment-tax_id" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
